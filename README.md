...
### [Audio analyzer](https://github.com/kamil7133/audio_analyzer)
Industry-grade audio analysis platform featuring
- Advanced Chroma & BPM Analysis – AI-driven key detection and multi-stage BPM analysis
- Studio-Grade Stem Separation – Deezer's Spleeter integration for vocal/instrumental separation
- YouTube Audio Extraction – Metadata-preserving audio extraction and processing
- Enterprise-Grade Architecture – Docker/Kubernetes, CI/CD, modular plugins, and smart caching
